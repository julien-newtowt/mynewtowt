...
def build_llms_txt(base_url: str) -> str:
    ...
    return (
        ...
        "une ligne régulière vers le Brésil et l'Amérique latine et transporte "
        "du fret palettisé (café, cacao, fret industriel, marchandises "
        "dangereuses incluses) en cales ségréguées, avec un CO₂ évité mesuré "
        "par lot et certifié Anemos (périmètre tank-to-wake, en CO₂). Présidée "
        "par Karl Sement.\n\n"
        "## Faits clés\n\n"
        "- Six voiliers-cargos sisterships de la classe TSC 80 : Anemos, "
        "Artemis et Atlantis en opération ; Atlas (livraison octobre 2026), "
        "Archimedes et Astérias (2027) en construction.\n"
