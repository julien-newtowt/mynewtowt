...
- Besoin : le trombinoscope du mois est disponible sans action humaine, chaque dernier jour du mois, **sans dépendre d'un flux Power Automate à configurer côté IT**.
...
- Acceptance : au dernier jour d'un mois simulé en environnement de test, le scheduler produit une nouvelle ligne `generated_reports` et une notification, sans intervention humaine ; un redémarrage de l'application le même jour ne produit pas de doublon.
